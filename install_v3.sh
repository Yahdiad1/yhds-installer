#!/bin/bash
# install_v3.sh - YHDS VPN + WS + Trojan + UDP-Custom 1-65535 + Auto-Restart
# ===========================================================
...
case $MENU in
    ...
    11) wget -O install_v3.sh "https://raw.githubusercontent.com/Yahdiad1/yhds-installer/main/install_v3.sh"
